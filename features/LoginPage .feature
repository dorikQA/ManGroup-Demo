...
#1 Login Page - Incorrect or incomplete email address Login -Verify warning message "Invalid Email address" will appear
...
#5 Login Page - Forgot your password?-Pop-up window "Forgot your password" will be open
...
# 6 Login Page - Forgot your password?-Empty email address
...
# 7 Login Page - Forgot password functionality - Correct email
...
#FORGOT YOUR PIN
# 8  Login Page - Forgot your pin?-Pop-up window "Forgot your pin" will be open
...
#9 Forgot your pin? - Empty email -  Warning message "Invalid Email address" will appear.
...
#10 Login Page - Forgot your pin? - Incorrect email -  Warning message "Invalid Email address" will appear.
...
#11 Login Page - Forgot your pin? - Correct email - "Thanks. We will be calling you to reset your pin shortly"
...
#LOGIN WITH VALID CREDENTIALS AND VERIFYING SUCCESS LOGIN
  #12  Login with valid credentials- Verify that user  is successfully login
